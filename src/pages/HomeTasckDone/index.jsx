...
import ChallengeName from '../../components/ChallengeName';
import ProgressBar from '../../components/ProgressBar';

// TODO - finish days 
export default function HomeTasckDone({ leftDays = 18, doneDays = 22, totalDays = 30, progress = 3 }) {
  const typeList = ["Heart", "Question", "Movie", "Book", "HandShake", "Share"]
    ...
    <>
      <main className={styles.teamScreen}>
        ...
        <div className={styles.bottom}>
          <Profile />
          <ChallengeName />          <div className={styles.button}>
            <div className={styles.progAndArrow}>
              <div>

                <div className={styles.ProgressBar}>
                  <ProgressBar typeList={typeList} progress={progress} />
                </div>
                <div className={styles.cardfortoday}>
                  {progress} / 6 cards for today
                </div>
              </div>
