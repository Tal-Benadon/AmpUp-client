...
import GoogelButton from '../../components/GoogelButton';
import styles from './style.module.scss';

export default function WelcomeScreen() {
    // TODO - if already logged in redirect to first active challenge || home
    ...
    return (
        <main className={styles.LoginSocialPage}>
            ...
            <div className={styles.buttons}>
                <GoogelButton />
                <Button>
                    <div className={styles.google}>{appleLogo} Continue with Apple</div>
                </Button>
            </div>
            <div className={styles.create}>
                <span>Don't have an account?</span>
                <span className={styles.create2}> Create Account</span>
            </div>
        </main>
    );
}